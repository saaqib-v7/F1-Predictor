...
class GradientBoostingPredictor:
    def __init__(self):
        ...
        self.model_path = 'race_predictor_gb.joblib'
    ...
    def train(self, data):
        print("Training F1 race prediction model (Gradient Boosting)...")
    ...
    def predict(self, driver, team, grid, avg_recent_finish=None, recent_points=None):
        ...
        try:
            ...
            win_prob = max(0.0, min(1.0, win_prob_raw))
